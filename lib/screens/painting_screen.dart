...
class _PaintingScreenState extends State<PaintingScreen> {
  Future<void> savePaintInDevice() async {
    ByteData? image = await Provider.of<PaintProvider>(context, listen: false)
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 0), () {
      Provider.of<PaintProvider>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    ...
    List<Color>? backgroundColors =
        Provider.of<PaintProvider>(context).getBackgroundColors;
    List<Tool>? toolsList = Provider.of<PaintProvider>(context).getToolsList;
    Color? selectedBackgroundColor =
        Provider.of<PaintProvider>(context).selectedBackgroundColor;
    Color? selectedLineColor =
        Provider.of<PaintProvider>(context).selectedLineColor;
    ...
    Color? sizeSelectorColor =
        Provider.of<PaintProvider>(context).lineSizeColor;
                                ...
                                Row(
                                  children: [
                                    ...toolsList!.map((tool) {
                                      return GestureDetector(
                                        onTap: () {
                                          panelActions.changeToolSelected =
                                              tool;
                                        },
                                        child: AnimatedContainer(
                                          duration:
